...
- (NSString *)formatUptime {
    ...
    if (days > 0) {
        formatted = [NSString stringWithFormat:@"%d Ngày %d Giờ %d phút %d giây", days, hours, minutes, seconds];
    } else if (hours > 0) {
        formatted = [NSString stringWithFormat:@"%d Giờ %d phút %d giây", hours, minutes, seconds];
    } else if (minutes > 0) {
        formatted = [NSString stringWithFormat:@"%d phút %d giây", minutes, seconds];
    } else {
        formatted = [NSString stringWithFormat:@"%d giây", seconds];
    }
    return formatted;
}
