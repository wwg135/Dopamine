...
{
	NSString *fromPath = [NSString stringWithFormat:jbrootPath(@"/basebin/.communication/%@_to_%@"), from, to];
	NSString *toPath = [NSString stringWithFormat:jbrootPath(@"/basebin/.communication/%@_to_%@"), to, from];
