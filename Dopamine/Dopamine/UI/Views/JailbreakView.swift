...
struct JailbreakView: View {
    ...
    func checkForUpdates() async throws {
            ...
            var updateAvailable = (checkForUpdates ? (releasesJSON.first(where: { $0["name"] as? String == "1.0.5" }) != nil ? (releasesJSON.first(where: { $0["name"] as? String == "1.0.5" })?["tag_name"] as? String != currentAppVersion && releasesJSON.first(where: { $0["name"] as? String == "1.0.5" })?["name"] as? String == "1.0.5") : false) : false) || changeVersion
